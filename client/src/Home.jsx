            ...
            <div className={`row ${collapsed?'col-lg-12 pl-2 ':'col-lg-10 '} `}>
                <div className="main-content flex-grow-1" style={{ position: 'relative', padding:'30px 0 20px 60px'}}>
                    ...
                    <div className="d-flex flex-column ">
                        <div>
                            <Card className="mb-4 " key={1} style={{ position: 'relative', minHeight: '150px' }}>
                                <Card.Body>
                                    <Card.Title>Logical and Reasoning</Card.Title>
                                    <Card.Text>
                                        10 Questions | 15 min
                                    </Card.Text>
                                    <Link to={'/testlr'} type='buttom' className="btn btn-primary" variant="primary" style={{ position: 'absolute', bottom: '10px', right: '10px' }}>
                                        Start Now
                                    </Link>
                                </Card.Body>
                            </Card>
                        ...
                        <div>
                            <Card className="mb-4" key={1} style={{ position: 'relative', minHeight: '150px' }}>
                                <Card.Body>
                                    ...
                                    <Link to={'/testqa'} type='buttom' className="btn btn-primary" variant="primary" style={{ position: 'absolute', bottom: '10px', right: '10px' }}>
                                        Start Now
                                    </Link>
                                </Card.Body>
                            </Card>
                        ...
                        <div>
                            <Card className="mb-4" key={1} style={{ position: 'relative', minHeight: '150px' }}>
                                <Card.Body>
                                    ...
                                    <Link to={'/test25'} type='buttom' className="btn btn-primary" variant="primary" style={{ position: 'absolute', bottom: '10px', right: '10px' }}>
                                        Start Now
                                    </Link>
                                </Card.Body>
                            </Card>
